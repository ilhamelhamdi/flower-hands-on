...
train_split = dataset["train"].train_test_split(test_size=1000, stratify_by_column="label", seed=42)
train_subset = train_split["test"]
eval_split = dataset["validation"].train_test_split(test_size=100, stratify_by_column="label", seed=42)
