...
def encode(examples):
    # QNLI provides 'question' and 'sentence'
...
train_split = dataset["train"].train_test_split(
    test_size=10000, stratify_by_column="label", seed=42)
...
training_args = TrainingArguments(
    output_dir="./lora_qnli_checkpoints",
    eval_strategy="epoch",
    save_strategy="epoch",
    num_train_epochs=5,
...
df.to_csv("training_resource_log-qnli_10epochs_10ktrain_1kval.csv", index=False)
